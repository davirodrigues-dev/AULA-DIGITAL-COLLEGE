...
if (botaoModoEscuro) {
    botaoModoEscuro.addEventListener('click', () => {
        ...
        botaoModoEscuro.setAttribute('aria-label', darkMode ? 'Ativar modo claro': 'Ativar modo escuro');
        ...
        botaoModoEscuro.textContent = darkMode ? 'Ativar Modo Claro' : 'Ativar Modo Escuro';
    });
}
